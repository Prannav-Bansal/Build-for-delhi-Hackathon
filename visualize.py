...
class YoloVisualizer:
    ...
    def __init__(self, dataset_folder):
        ...
        classes_file = os.path.join(dataset_folder, "classes.txt")  # updated path
    ...
    def set_mode(self, mode=MODE_TRAIN):
        if mode == self.MODE_TRAIN:
            self.images_folder = os.path.join(self.dataset_folder, "data", "train", "images")  # updated path
            self.labels_folder = os.path.join(self.dataset_folder, "data", "train", "labels")  # updated path
        else:
            self.images_folder = os.path.join(self.dataset_folder, "data", "val", "images")    # updated path
            self.labels_folder = os.path.join(self.dataset_folder, "data", "val", "labels")    # updated path
